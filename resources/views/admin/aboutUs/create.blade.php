                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('language_id',$language,null,['class'=>Lang::locale()==='kh' ? 'kh-os edit-form-control text-blue height-35' : 'arial edit-form-control text-blue height-35','required','placeholder'=>trans('label.choose_item')]) !!}
                            </div>
                            @if($errors->has('language_id'))
                                <span class="text-danger {{Lang::locale()=='kh' ? 'kh-os' : 'arial'}}">{{$errors->first('language_id')}}</span>
                            @endif
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('category_id',$category,$aId,['class'=>Lang::locale()==='kh' ? 'kh-os edit-form-control text-blue height-35' : 'arial edit-form-control text-blue height-35','required','placeholder'=>trans('label.choose_item')]) !!}
                            </div>
                            @if($errors->has('category_id'))
                                <span class="text-danger {{Lang::locale()=='kh' ? 'kh-os' : 'arial'}}">{{$errors->first('category_id')}}</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if($errors->has('description'))
                                <span class="text-danger {{Lang::locale()=='kh' ? 'kh-os' : 'arial'}}">{{$errors->first('description')}}</span>
                            @endif
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{route('aboutus.index')}}" class="btn btn-info btn-sm {{Lang::locale()==='kh' ? 'kh-os' : 'arial'}}">{{trans('label.view')}}</a>
                            </div>
