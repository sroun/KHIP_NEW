<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content" style="border-radius: 10px;">
        @foreach($data as $d)
            {!! Form::open(['action'=>['JobcategoryController@update',$d->id],'method'=>'PATCH']) !!}
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            {!! Form::text('name',$d->pivot->name,['class'=>Lang::locale()==='kh' ?'kh-os edit-form-control height-35 text-blue' : 'arial edit-form-control height-35 text-blue','placeholder'=>trans('label.name'),'required']) !!}
                        </div>
                    </div>
                </div>
            </div>
